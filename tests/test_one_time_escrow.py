...
def test_one_time_escrow(token_contract, asset_contract, chain):
    ...
    account0 = chain.web3.eth.accounts[0] # seller
    account1 = chain.web3.eth.accounts[1] # buyer
    ...
    # Wei is the small order of ether (like Satoshi in BTC)
    ...
    # there is no from because account0 does this
